...
Pod::Spec.new do |s|
  ...
  s.version          = "1.0.0"
  s.summary          = "A lightweight Project Template and scripts that wraps cslim to help you get setup writing fast, rock solid, non UI based Acceptance Tests using Fitnesse."
  s.description      = <<-DESC
