...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  OCSlimProjectTestBundleSupport provides a suite of dynamic XCTests that can be run within Xcode or as part of an Xcode build that allows you report the results of Acceptance Tests generated by running with Fitnesse.
                   DESC
